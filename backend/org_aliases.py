"""Pure organization-name aliasing / classification — NO database or app deps.

Extracted from org_extractor so name resolution is a leaf module: target_accounts
(and thus scoring) can resolve sponsor names WITHOUT transitively importing db.
org_extractor re-exports these names for backward compatibility.
"""
import re
